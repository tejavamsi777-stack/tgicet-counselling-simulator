      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base sm:text-lg font-bold text-white">Top 5 Engineering Institutions Leaderboard</h3>
            <span className="rounded-full bg-purple-500/20 border border-purple-500/30 px-2 py-0.5 text-[9px] font-bold text-purple-300">
              Top 5 Only
            </span>
          </div>
