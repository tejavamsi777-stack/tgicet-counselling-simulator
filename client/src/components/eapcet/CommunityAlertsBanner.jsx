      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
        <div className="max-w-xl">
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
            Never miss a seat allotment, sliding date, or fee deadline.
          </h3>
          <p className="text-xs sm:text-sm text-white/60 mt-2 leading-relaxed">
            Join thousands of Telangana engineering aspirants in our official live updates channels. Get real-time alerts when Phase allotments, vacancy statements, and high court fee orders drop.
          </p>

          <div className="flex items-center gap-4 mt-4 text-xs text-white/50">
            <span className="flex items-center gap-1.5">
              <Users size={14} className="text-purple-300" />
              <span>12,000+ Active Aspirants</span>
            </span>
            <span>•</span>
            <span className="flex items-center gap-1.5">
