      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 z-[160] w-[92%] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-[28px] border border-white/50 bg-white/90 p-8 shadow-2xl backdrop-blur-2xl"
          >
            <button
              onClick={onClose}
            ...
            <div className="mb-6 flex flex-col items-center text-center">
              <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-[#312e81] via-[#7c3aed] to-[#0e7490] text-white">
                <Sparkles size={20} />
              </div>
