...
export default function EapcetAllotmentsPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[1600px] px-4 py-8 sm:px-6 md:px-10 lg:px-14 sm:py-12">
      <Seo
        title="TG EAPCET Seat Allotments 2027 | College-Wise Candidate Records & Cutoffs"
        description="Official TG EAPCET college-wise provisional seat allotment records from tgeapcet.nic.in. Search all candidates, closing cutoffs, and seat categories across 200+ engineering colleges."
        keywords="tg eapcet seat allotments 2027, ts eamcet college wise candidate allotment list, tgeapcet nic in allotment order data, tg eapcet cse cutoff ranks college wise"
      ...
      <div className="mb-8">
        <div className="inline-flex items-center gap-2 rounded-full border border-purple-500/30 bg-purple-500/10 px-3 py-1 text-xs font-semibold text-purple-300">
          <Database size={13} />
          <span>Seat Allotment Analytics · 2027</span>
        </div>
        <h1
          className="mt-3 text-3xl sm:text-4xl font-bold tracking-tight text-white"
          style={{ fontFamily: 'var(--font-display)' }}
        >
          TG EAPCET 2027 College-Wise Seat Allotment Explorer
        </h1>
      ...
      <ToolGuideSection toolType="allotments" examName="TG EAPCET" authorityName="TSCHE" />
