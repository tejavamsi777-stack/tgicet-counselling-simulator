...
export default function EapcetMockCounsellingPage() {
  ...
  function handleCandidateSubmit() {
    if (rank.toString().trim() === "") { setCandidateError("Please enter your TG EAPCET Rank"); return; }
  ...
  return (
    <main className={`relative mx-auto overflow-visible w-full max-w-[1600px] px-4 sm:px-6 md:px-10 lg:px-14 ${step === "list" ? "space-y-1.5 pb-4 pt-2" : "space-y-8 pb-44 pt-6"}`}>
      ...
      <ToolGuideSection toolType="mock_counselling" examName="TG EAPCET" authorityName="TSCHE" />
    </main>
  );
}
