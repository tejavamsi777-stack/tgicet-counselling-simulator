...
export default function EapcetComparePage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[1600px] px-4 py-8 sm:px-6 md:px-10 lg:px-14 sm:py-12">
      ...
      >
        <ArrowLeft size={14} />
        <span>Back to AP EAPCET Admissions Suite</span>
      </Link>
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm sm:text-base text-gray-300 max-w-2xl">
          Evaluate any two Andhra Pradesh engineering colleges side-by-side across 3-year cutoff benchmarks, highest/average packages, and government fee tiers.
        </p>
      </div>
