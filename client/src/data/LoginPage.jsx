...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-[#312e81] via-[#7c3aed] to-[#0e7490] p-12 text-white lg:flex">
        ...
        <p className="relative z-10 text-sm text-white/50">TG ICET · MBA &amp; MCA Counselling</p>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-center bg-slate-50 px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-sm">
          <Link
            to="/"
            className="mb-8 inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 hover:text-slate-800"
          >
            <ArrowLeft size={15} />
            Back to home
          </Link>
