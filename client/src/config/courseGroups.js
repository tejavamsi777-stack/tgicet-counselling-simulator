export const EXAM_COURSE_GROUPS = {
  ...
  "tg-ecet": {
    selectorGroups: [
      {
        group: "COMPUTER SCIENCE & IT SPECIALIZATIONS",
        branches: [
      ...
      {
        group: "CORE ENGINEERING BRANCHES",
        branches: [
          ...
          { code: "EVL", name: "ELECTRONICS (VLSI DESIGN & TECHNOLOGY)" },
    ...
    preferenceGroups: [
      ...
      { title: "CSM — CSE (AI & MACHINE LEARNING)", courses: ["CSM"] },
      { title: "CSD — CSE (DATA SCIENCE)", courses: ["CSD"] },
      { title: "AID — ARTIFICIAL INTELLIGENCE & DATA SCIENCE", courses: ["AID"] },
      { title: "AIM — ARTIFICIAL INTELLIGENCE & MACHINE LEARNING", courses: ["AIM"] },
      { title: "CSC — CSE (CYBER SECURITY)", courses: ["CSC"] },
      { title: "CIC — CSE (IoT & CYBER SECURITY)", courses: ["CIC"] },
      { title: "CSB — COMPUTER SCIENCE & BUSINESS SYSTEMS", courses: ["CSB"] },
      ...
      { title: "EVL — ELECTRONICS (VLSI DESIGN & TECHNOLOGY)", courses: ["EVL"] },
      { title: "BME — B.TECH BIOMEDICAL ENGINEERING", courses: ["BME"] },
      { title: "AUT — AUTOMOBILE ENGINEERING", courses: ["AUT"] },
