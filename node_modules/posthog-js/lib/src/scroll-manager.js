...
var ScrollManager = /** @class */ (function () {
    ...
    ScrollManager.prototype._scrollPosition = function (axis) {
        var elementKey = axis === 'y' ? 'scrollTop' : 'scrollLeft';
        if (this._scrollRoot) {
        ...
        return axis === 'y'
            ? globals_1.window.scrollY || globals_1.window.pageYOffset || globals_1.window.document.documentElement.scrollTop || 0
            : globals_1.window.scrollX || globals_1.window.pageXOffset || globals_1.window.document.documentElement.scrollLeft || 0;
    };
