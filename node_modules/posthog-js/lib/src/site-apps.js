...
var SiteApps = /** @class */ (function () {
    function SiteApps(_instance) {
        ...
        this._siteAppElementPatchCount = 0;
    ...
    SiteApps.prototype._prepareElementForSiteApp = function (element) {
        var _a;
        ...
        if (tagName === 'style' && this._instance.config.prepare_external_dependency_stylesheet) {
            var prepared = this._instance.config.prepare_external_dependency_stylesheet(element);
            if (!prepared) {
        ...
        if (tagName === 'script' && this._instance.config.prepare_external_dependency_script) {
            var prepared = this._instance.config.prepare_external_dependency_script(element);
            if (!prepared) {
    ...
    SiteApps.prototype._patchSiteAppElementInsertionMethods = function () {
        var _this = this;
        var _a, _b, _c, _d, _e, _f, _g, _h;
        if (!this._instance.config.prepare_external_dependency_stylesheet &&
            !this._instance.config.prepare_external_dependency_script) {
            return function () { };
        }
        var win = globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.defaultView;
        var nodePrototype = (_a = win === null || win === void 0 ? void 0 : win.Node) === null || _a === void 0 ? void 0 : _a.prototype;
        ...
        var restore = [];
        var siteApps = this;
        var preparedNodes = new WeakSet();
        var patch = function (prototype, method, replacement) {
            if (!(prototype === null || prototype === void 0 ? void 0 : prototype[method])) {
                return;
            }
        ...
        var prepareNode = function (node) {
            ...
            var prepared = siteApps._prepareElementForSiteApp(node);
            if (prepared) {
        ...
        var prepareNodes = function (nodes) {
            return nodes
                .map(function (node) { return (typeof node === 'string' ? node : prepareNode(node)); })
                .filter(function (node) { return !(0, core_1.isNull)(node); });
        };
        patch(nodePrototype, 'appendChild', function (original) {
            return function (child) {
                var prepared = prepareNode(child);
                return prepared ? original.call(this, prepared) : child;
            };
        });
        patch(nodePrototype, 'insertBefore', function (original) {
            return function (newChild, refChild) {
                var prepared = prepareNode(newChild);
                return prepared ? original.call(this, prepared, refChild) : newChild;
            };
        });
        patch(nodePrototype, 'replaceChild', function (original) {
            return function (newChild, oldChild) {
                var prepared = prepareNode(newChild);
                return prepared ? original.call(this, prepared, oldChild) : oldChild;
            };
        });
        [(_b = win.Element) === null || _b === void 0 ? void 0 : _b.prototype, (_c = win.Document) === null || _c === void 0 ? void 0 : _c.prototype, (_d = win.DocumentFragment) === null || _d === void 0 ? void 0 : _d.prototype].forEach(function (prototype) {
            patch(prototype, 'append', function (original) {
                return function () {
                    var nodes = [];
            ...
            patch(prototype, 'prepend', function (original) {
                return function () {
                    var nodes = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        nodes[_i] = arguments[_i];
        ...
        [(_e = win.Element) === null || _e === void 0 ? void 0 : _e.prototype, (_f = win.CharacterData) === null || _f === void 0 ? void 0 : _f.prototype, (_g = win.DocumentType) === null || _g === void 0 ? void 0 : _g.prototype].forEach(function (prototype) {
            patch(prototype, 'before', function (original) {
                return function () {
                    var nodes = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        nodes[_i] = arguments[_i];
            ...
            patch(prototype, 'after', function (original) {
                return function () {
                    var nodes = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        nodes[_i] = arguments[_i];
            ...
            patch(prototype, 'replaceWith', function (original) {
                return function () {
                    var nodes = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        nodes[_i] = arguments[_i];
                    }
                    var prepared = prepareNodes(nodes);
                    return nodes.length && !prepared.length ? undefined : original.apply(this, prepared);
                };
            });
        });
        patch((_h = win.Element) === null || _h === void 0 ? void 0 : _h.prototype, 'insertAdjacentElement', function (original) {
            return function (position, insertedElement) {
                var prepared = prepareNode(insertedElement);
                return prepared ? original.call(this, position, prepared) : null;
            };
        });
        this._restoreSiteAppElementPatches = function () {
            restore.forEach(function (restore) { return restore(); });
            _this._restoreSiteAppElementPatches = undefined;
        };
        return this._releaseSiteAppElementPatches();
    };
    SiteApps.prototype._releaseSiteAppElementPatches = function () {
        var _this = this;
        var released = false;
        return function () {
            var _a;
            ...
            released = true;
            _this._siteAppElementPatchCount--;
            if (_this._siteAppElementPatchCount === 0) {
                (_a = _this._restoreSiteAppElementPatches) === null || _a === void 0 ? void 0 : _a.call(_this);
            }
        };
    };
    SiteApps.prototype._runWithPreparedSiteAppElements = function (callback, restoreSynchronously) {
        if (restoreSynchronously === void 0) { restoreSynchronously = true; }
        var restore = this._patchSiteAppElementInsertionMethods();
        try {
            var result = callback(restore);
    ...
    SiteApps.prototype.setupSiteApp = function (loader) {
        ...
        var processBufferedEvents = function () {
            ...
            if (!app.errored && _this._bufferedInvocations.length) {
                ...
                _this._bufferedInvocations.forEach(function (globals) {
                    return _this._runWithPreparedSiteAppElements(function () { var _a; return (_a = app.processEvent) === null || _a === void 0 ? void 0 : _a.call(app, globals); });
                });
        ...
        try {
            var processEvent = this._runWithPreparedSiteAppElements(function (restore) {
                return loader.init({
                    posthog: _this._instance,
    ...
    SiteApps.prototype._onCapturedEvent = function (event) {
        ...
        var _loop_1 = function (app) {
            try {
                this_1._runWithPreparedSiteAppElements(function () { var _a; return (_a = app.processEvent) === null || _a === void 0 ? void 0 : _a.call(app, globals); });
            }
            catch (e) {
        ...
        var this_1 = this;
        try {
            for (var _b = __values(Object.values(this.apps)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var app = _c.value;
                _loop_1(app);
            }
        }
    ...
    SiteApps.prototype.onRemoteConfig = function (response) {
        ...
        var _loop_2 = function (id, url) {
            globals_1.assignableWindow["__$$ph_site_app_".concat(id)] = this_2._instance;
            (_f = (_e = globals_1.assignableWindow.__PosthogExtensions__) === null || _e === void 0 ? void 0 : _e.loadSiteApp) === null || _f === void 0 ? void 0 : _f.call(_e, this_2._instance, url, function (err) {
                if (err) {
