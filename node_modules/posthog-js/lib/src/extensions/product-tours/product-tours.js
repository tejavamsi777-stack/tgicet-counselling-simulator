...
exports.doesTourUrlMatch = doesTourUrlMatch;
...
function doesTourUrlMatch(tour, instance) {
    var conditions = tour.conditions;
    if (!(conditions === null || conditions === void 0 ? void 0 : conditions.url)) {
        return true;
    }
    var href = (0, url_targeting_utils_1.getTargetingUrl)(instance);
    if (!href) {
        return false;
    }
...
function checkTourConditions(tour, instance) {
    var _a;
    return (isTourInDateRange(tour) && doesTourUrlMatch(tour, instance) && (0, matcher_utils_1.doesDeviceTypeMatch)((_a = tour.conditions) === null || _a === void 0 ? void 0 : _a.deviceTypes));
}
...
function retrieveTourShadow(tour, posthog) {
    ...
    var stylesheet = (0, product_tours_utils_1.getProductTourStylesheet)(posthog);
    if (stylesheet) {
...
function retrieveBannerShadow(tour, posthog, bannerConfig) {
    var _a;
    var containerClass = "".concat(CONTAINER_CLASS, "-").concat(tour.id);
    var existingDiv = document.querySelector(".".concat(containerClass));
    if (existingDiv && existingDiv.shadowRoot) {
...
var ProductTourManager = /** @class */ (function () {
    ...
    ProductTourManager.prototype._renderTooltipWithPreact = function (element, onSurveySubmit, onDismissOverride) {
        ...
        var shadow = retrieveTourShadow(this._activeTour, this._instance).shadow;
    ...
    ProductTourManager.prototype._renderBanner = function () {
        ...
        var result = retrieveBannerShadow(this._activeTour, this._instance, step.bannerConfig);
        if (!result) {
