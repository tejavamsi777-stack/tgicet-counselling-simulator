...
function SurveyPopup(_a) {
    ...
    var survey = _a.survey, forceDisableHtml = _a.forceDisableHtml, posthog = _a.posthog, _h = _a.style, style = _h === void 0 ? {} : _h, previewPageIndex = _a.previewPageIndex, _j = _a.removeSurveyFromFocus, removeSurveyFromFocus = _j === void 0 ? function () { } : _j, _k = _a.isPopup, isPopup = _k === void 0 ? true : _k, _l = _a.onPreviewSubmit, onPreviewSubmit = _l === void 0 ? function () { } : _l, _m = _a.onPreviewBack, onPreviewBack = _m === void 0 ? function () { } : _m, _o = _a.onPopupSurveyDismissed, onPopupSurveyDismissed = _o === void 0 ? function () { } : _o, _p = _a.onCloseConfirmationMessage, onCloseConfirmationMessage = _p === void 0 ? function () { } : _p, properties = _a.properties, isSurveyCompleted = _a.isSurveyCompleted, skipShownEvent = _a.skipShownEvent, surveyLanguage = _a.surveyLanguage;
    ...
    var surveyPopupDelayMilliseconds = ((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.surveyPopupDelaySeconds)
        ...
        : 0;
    var _q = usePopupVisibility(survey, posthog, surveyPopupDelayMilliseconds, isPreviewMode, removeSurveyFromFocus, isPopup, surveyContainerRef, skipShownEvent, surveyLanguage), isPopupVisible = _q.isPopupVisible, isSurveySent = _q.isSurveySent, hidePopupWithViewTransition = _q.hidePopupWithViewTransition;
    /**
...
function Questions(_a) {
    ...
    var _g = __read((0, hooks_1.useState)(function () {
        var _a;
        var inProgressSurveyData = (0, surveys_extension_utils_1.getInProgressSurveyState)(survey);
        return (_a = inProgressSurveyData === null || inProgressSurveyData === void 0 ? void 0 : inProgressSurveyData.visitedIndices) !== null && _a !== void 0 ? _a : [];
