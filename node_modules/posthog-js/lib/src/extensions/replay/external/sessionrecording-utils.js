...
function estimateStringBytes(data) {
    return new Blob([data]).size;
}
function estimateSize(sizeable) {
    var stringifiedData = JSON.stringify(sizeable, circularReferenceReplacer());
...
function ensureMaxMessageSize(data) {
    ...
    var size = estimateStringBytes(stringifiedData);
    if (size > exports.MAX_MESSAGE_SIZE) {
        ...
        var unfilteredStringifiedData = stringifiedData;
        try {
    ...
    return { event: JSON.parse(stringifiedData), size: size };
}
