...
function elementOrParentPositionMatches(el, matches, breakOnElement) {
    ...
    while (curEl && (0, element_utils_1.isElementNode)(curEl) && !(0, element_utils_1.isTag)(curEl, 'body')) {
        ...
        var position = void 0;
        try {
            position = (_c = ((_b = (_a = curEl.ownerDocument) === null || _a === void 0 ? void 0 : _a.defaultView) !== null && _b !== void 0 ? _b : globals_1.window)) === null || _c === void 0 ? void 0 : _c.getComputedStyle(curEl).position;
        }
        catch (_d) {
            return false;
        }
        if ((0, core_2.includes)(matches, position)) {
            return true;
        }
...
var Heatmaps = /** @class */ (function () {
    ...
    Heatmaps.prototype._onClick = function (e, type) {
        ...
        if (((_a = this.rageclicks) === null || _a === void 0 ? void 0 : _a.isRageClick(e.clientX, e.clientY, new Date().getTime())) &&
            (0, autocapture_utils_1.shouldCaptureRageclick)((0, autocapture_utils_1.getEventTarget)(e), this.instance.config.rageclick)) {
    ...
    Heatmaps.prototype._capture = function (properties) {
        ...
        var href = this._config.disable_capture_url_hashes ? (0, core_1.stripUrlHash)(globals_1.window.location.href) : globals_1.window.location.href;
