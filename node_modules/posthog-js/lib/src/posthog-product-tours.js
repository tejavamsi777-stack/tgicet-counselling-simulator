...
var PostHogProductTours = /** @class */ (function () {
    ...
    PostHogProductTours.prototype.onRemoteConfig = function (response) {
        ...
        if (!isProductToursEnabled(this._instance)) {
            if (this._productTourManager || !(0, core_1.isNullish)((_b = this._persistence) === null || _b === void 0 ? void 0 : _b.props[constants_1.PRODUCT_TOURS])) {
            ...
            (_c = this._productTourManager) === null || _c === void 0 ? void 0 : _c.stop();
            this._productTourManager = null;
    ...
    PostHogProductTours.prototype.getProductTours = function (callback, forceReload) {
        ...
        this._instance._send_request({
            ...
            callback: function (response) {
                var _a;
                if (!isProductToursEnabled(_this._instance)) {
