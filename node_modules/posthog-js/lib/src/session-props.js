...
var generateSessionSourceParams = function (posthog) {
    return (0, event_utils_1.getPersonInfo)(posthog === null || posthog === void 0 ? void 0 : posthog.config.mask_personal_data_properties, posthog === null || posthog === void 0 ? void 0 : posthog.config.custom_personal_data_properties, posthog === null || posthog === void 0 ? void 0 : posthog.config.disable_capture_url_hashes);
};
var SessionPropsManager = /** @class */ (function () {
    ...
    SessionPropsManager.prototype.getSetOnceProps = function () {
        ...
        if ('r' in p) {
            return (0, event_utils_1.getPersonPropsFromInfo)(p, this._instance.config.disable_capture_url_hashes);
        }
        else {
            return {
