...
function getPersonInfo(maskPersonalDataProperties, customPersonalDataProperties, disableCaptureUrlHashes) {
    if (disableCaptureUrlHashes === void 0) { disableCaptureUrlHashes = false; }
    var paramsToMask = maskPersonalDataProperties
        ? __spreadArray(__spreadArray([], __read(exports.PERSONAL_DATA_CAMPAIGN_PARAMS), false), __read((customPersonalDataProperties || [])), false) : [];
    var href = disableCaptureUrlHashes ? (0, core_1.stripUrlHash)(globals_1.location === null || globals_1.location === void 0 ? void 0 : globals_1.location.href) : globals_1.location === null || globals_1.location === void 0 ? void 0 : globals_1.location.href;
    var url = href === null || href === void 0 ? void 0 : href.substring(0, 1000);
...
function getPersonPropsFromInfo(info, disableCaptureUrlHashes) {
    var _a;
    if (disableCaptureUrlHashes === void 0) { disableCaptureUrlHashes = false; }
    var referrer = info.r, u = info.u;
    var url = disableCaptureUrlHashes ? (0, core_1.stripUrlHash)(u) : u;
...
function getInitialPersonPropsFromInfo(info, disableCaptureUrlHashes) {
    if (disableCaptureUrlHashes === void 0) { disableCaptureUrlHashes = false; }
    var personProps = getPersonPropsFromInfo(info, disableCaptureUrlHashes);
    var props = {};
...
function getEventProperties(maskPersonalDataProperties, customPersonalDataProperties, detectGoogleSearchApp, disableCaptureUrlHashes) {
    var _a, _b, _c;
    if (disableCaptureUrlHashes === void 0) { disableCaptureUrlHashes = false; }
    ...
    var properties = (0, index_1.extend)((0, index_1.stripEmptyProperties)({
        ...
        $current_url: (0, request_utils_1.maskQueryParams)(disableCaptureUrlHashes ? (0, core_1.stripUrlHash)(globals_1.location === null || globals_1.location === void 0 ? void 0 : globals_1.location.href) : globals_1.location === null || globals_1.location === void 0 ? void 0 : globals_1.location.href, paramsToMask, exports.MASKED),
