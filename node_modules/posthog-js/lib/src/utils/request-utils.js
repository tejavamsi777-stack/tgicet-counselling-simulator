...
exports.updateStatusZeroFailureCount = exports.isStatusZeroFailureCircuitBreakerTripped = exports.isLocalhost = exports._getHashParam = exports.maskQueryParams = exports.getQueryParam = exports.formDataToQuery = exports.convertToURL = void 0;
var _1 = require("./");
...
var isStatusZeroFailureCircuitBreakerTripped = function (consecutiveStatusZeroFailures, maxConsecutiveStatusZeroFailures) {
    return consecutiveStatusZeroFailures >= maxConsecutiveStatusZeroFailures && (0, globals_1.isBrowserOnline)();
};
exports.isStatusZeroFailureCircuitBreakerTripped = isStatusZeroFailureCircuitBreakerTripped;
var updateStatusZeroFailureCount = function (statusCode, consecutiveStatusZeroFailures, maxConsecutiveStatusZeroFailures, onCircuitBreakerTripped) {
    if (statusCode === 0) {
        if ((0, globals_1.isBrowserOnline)()) {
            var updatedConsecutiveStatusZeroFailures = consecutiveStatusZeroFailures + 1;
...
exports.updateStatusZeroFailureCount = updateStatusZeroFailureCount;
