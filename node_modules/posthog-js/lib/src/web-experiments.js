...
exports.webExperimentUrlValidationMap = {
    icontains: function (conditionsUrl, href) { return href.toLowerCase().indexOf(conditionsUrl.toLowerCase()) > -1; },
    not_icontains: function (conditionsUrl, href) { return href.toLowerCase().indexOf(conditionsUrl.toLowerCase()) === -1; },
    regex: function (conditionsUrl, href) { return (0, regex_utils_1.isMatchingRegex)(href, conditionsUrl); },
    not_regex: function (conditionsUrl, href) { return !(0, regex_utils_1.isMatchingRegex)(href, conditionsUrl); },
    exact: function (conditionsUrl, href) { return href === conditionsUrl; },
    is_not: function (conditionsUrl, href) { return href !== conditionsUrl; },
};
var WebExperiments = /** @class */ (function () {
                ...
                webExperiments.forEach(function (webExperiment) {
                    ...
                    if (webExperiment.feature_flag_key) {
                        ...
                        for (var variant in webExperiment.variants) {
                            ...
                            var matchTest = WebExperiments._matchesTestVariant(testVariant, _this._instance);
                            if (matchTest) {
    ...
    WebExperiments._matchesTestVariant = function (testVariant, instance) {
        if ((0, core_1.isNullish)(testVariant.conditions)) {
            return false;
        }
        return (WebExperiments._matchUrlConditions(testVariant, instance) && WebExperiments._matchUTMConditions(testVariant));
    };
    WebExperiments._matchUrlConditions = function (testVariant, instance) {
        var _a, _b, _c, _d;
        ...
        if (location) {
            ...
            var href = (0, url_targeting_utils_1.applyUrlTargetingOverride)(instance, location.href);
            var urlCheck = ((_b = testVariant.conditions) === null || _b === void 0 ? void 0 : _b.url)
                ? exports.webExperimentUrlValidationMap[(_d = (_c = testVariant.conditions) === null || _c === void 0 ? void 0 : _c.urlMatchType) !== null && _d !== void 0 ? _d : 'icontains'](testVariant.conditions.url, href)
                : true;
            return urlCheck;
        }
        return false;
